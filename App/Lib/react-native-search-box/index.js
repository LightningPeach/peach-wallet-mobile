  ...
  onSearch = async () => {
    if (this.props.beforeSearch) {
      await this.props.beforeSearch(this.state.keyword, () => {
        ...
        }, async () => await this.collapseAnimation(true));
      });
    }
    ...
    if (this.props.onSubmitEditing) {
      this.props.onSubmitEditing(async () => {
      });
    }
  };
    ...
    return (
      <Animated.View
        ...
        style={[
          ...
          this.props.containerStyles && this.props.containerStyles
        ]}
...
const getStyles = (inputHeight, isRtl) => {
  ...
  return {
    ...
    input: {
      ...
      paddingTop: 5,
      paddingBottom: 5,
      [isRtl ? 'paddingRight' : 'paddingLeft']: 30,
